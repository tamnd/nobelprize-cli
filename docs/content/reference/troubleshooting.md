...
Most of these come down to network reality or how nobelprize serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nobelprize rate-limits like any public site. nobelprize already paces
...
Where a surface is gated, nobelprize reads a cookie or token you supply
...
`nobelprize`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nobelprize actually did
