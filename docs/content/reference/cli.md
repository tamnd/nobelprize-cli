...
```
nobelprize <command> [arguments] [flags]
```

Run `nobelprize <command> --help` for the full flag list on any command. This
...
per operation you declare in `nobelprize/domain.go`.
